...
const KEYBOARD_KEY_ARRAY: KeyboardKeyArrayInterface = {
    ...
    'PageUp':{ nKeyId : 79 , keyText : "PageUp" },
    'Delete':{ nKeyId : 80 , keyText : "Delete" }, 
    'End':{ nKeyId : 81 , keyText : "End" }, 
    'PageDown':{ nKeyId : 82 , keyText : "PageDown" },
    'ArrowUp':{ nKeyId : 83 , keyText : "ArrowUp" },
    'ArrowLeft':{ nKeyId : 84 , keyText : "ArrowLeft" }, 
    'ArrowDown':{ nKeyId : 85 , keyText : "ArrowDown" }, 
    'ArrowRight':{ nKeyId : 86 , keyText : "ArrowRight" },
    ...
    'NumLock':{ nKeyId: 91, keyText: "NumLock"}, 
    '/N': {nKeyId: 92, keyText:"/N"}, 
    '*N': {nKeyId: 93, keyText:"*N"}, 
    '-N': {nKeyId: 94, keyText:"-N"},
    '7N':{nKeyId: 95, keyText:"7N"}, 
    '8N':{nKeyId: 96, keyText:"8N"}, 
    '9N':{nKeyId: 97, keyText:"9N"}, 
    '+N':{nKeyId: 98, keyText:"+N"},
    '4N':{nKeyId: 99, keyText:"4N"}, 
    '5N':{nKeyId: 100, keyText:"5N"}, 
    '6N':{nKeyId: 101, keyText:"6N"},
    '1N':{nKeyId: 102, keyText:"1N"}, 
    '2N':{nKeyId: 103, keyText:"2N"}, 
    '3N':{nKeyId: 104, keyText:"3N"}, 
    'EnterN':{nKeyId: 105, keyText:"EnterN"},
    '0N':{nKeyId: 106, keyText:"0N"}, 
    '.N':{nKeyId: 107, keyText:".N"},
